...
cp out/arch/arm64/boot/dts/google/qcom-base/sm8150.dtb "$TOP/device/google/$DEVICE-kernel"
cp out/arch/arm64/boot/dts/google/qcom-base/sm8150-v2.dtb "$TOP/device/google/$DEVICE-kernel"
